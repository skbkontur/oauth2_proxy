...
func main() {
	...
	flagSet.String("authorization-file", "", "authentication file (yaml) with allowed domains and groups")
	...
	flagSet.String("cookie-same-site", "", "an optional cookie SameSite attribute for restrict cross-site requests (None, Strict, Lax)")
